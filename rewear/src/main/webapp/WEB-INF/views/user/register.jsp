...
<body>
	...
	<div class="container">
		<div class="registration-form">
			<img src="https://cdn-icons-png.flaticon.com/512/194/194931.png"
				alt="Logo" class="logo">
			...
			%>
			<span style="color: red;"><%=emailExists%></span><br>
			<%
			}
			%>
			...
			<form action="/register" method="post">
				...
				<div class="mb-3">
					...
					if (request.getAttribute("errors") != null) {
						...
						if (errors.getFieldError("password") != null) {
							out.println(
							"<div class='text-danger small'>" + errors.getFieldError("password").getDefaultMessage() + "</div>");
						}
					}
					%>
				</div>
				...
				<div class="mb-3">
					<label class="form-label">Gender</label> <select name="gender"
						...
						<option value="OTHER"
							<%="OTHER".equals(request.getParameter("gender")) ? "selected" : ""%>>Other</option>
					</select>
					<%
					if (request.getAttribute("errors") != null) {
						var errors = (org.springframework.validation.Errors) request.getAttribute("errors");
